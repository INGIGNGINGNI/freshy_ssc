...
<head>
    ...
    <title>SSC Admin - Dashboard [EDIT]</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Profile of Freshmen Girl</h1>
                    <div class="row">
                        <div class="col-lg-4">
                            <!-- Circle Buttons -->
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="editgirl_db.php" method="post" enctype="multipart/form-data">
                                        <?php
                                            if (isset($_GET['id'])) {
                                                    $id = $_GET['id'];
                                                    $stmt = $conn->query("SELECT * FROM freshmen_girl WHERE id = $id");
                                                    $stmt->execute();
                                                    $data = $stmt->fetch();
                                            }
                                        ?>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editgirl_db.php?id=<?php echo $cont['id']; ?>" class="btn btn-warning btn-icon-split">
                    ...
                    return new Promise(function(resolve) {[
                        ...
                        .done(function() {
                            Swal.fire({
                                ...
                                document.location.href = 'freshmengirl.php';
                            })
                        })
                        .fail(function() {
