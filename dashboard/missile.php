<?php 
    ...
    if (isset($_GET['delete'])) {
        ...
        $deleteboy = $conn->query("DELETE FROM missile WHERE id = $delete_id");
        $deleteboy->execute();
...
<head>
    ...
    <title>SSC Admin - Dashboard [Missile]</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Profile of Missile</h1>
                    <div class="row">
                        <div class="col-lg-4">
                            <!-- Circle Buttons -->
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                        <form action="missile_db.php" method="post" enctype="multipart/form-data">
                                            <div class="mb-3">
