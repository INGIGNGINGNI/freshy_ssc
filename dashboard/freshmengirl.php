<?php 
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($deletegirl) {
            ...
            header("refresh:1; url=freshmengirl.php");
        }    
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>SSC Admin - Dashboard [FreshmenGirl]</title>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="freshmengirl_edit.php?id=<?php echo $cont['id']; ?>" class="btn btn-warning btn-icon-split">
